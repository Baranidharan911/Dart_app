...
import 'package:techwiz/payments_gateway.dart';
...
class UIPage extends StatefulWidget {
  ...
  const UIPage({super.key, required this.username});
...
class _ImageCarouselState extends State<ImageCarousel> {
  ...
  Future<List<Map<String, dynamic>>> fetchImagesAndRoutes() async {
    try {
      final snapshot = await FirebaseFirestore.instance
          .collection('images') // Assuming you are storing image URLs and routes in this collection
          .get();
